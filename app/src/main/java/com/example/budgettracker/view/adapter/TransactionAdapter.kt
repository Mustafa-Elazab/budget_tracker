package com.example.budgettracker.view.adapter
...
import com.example.budgettracker.databinding.ItemTransactionLayoutBinding
import com.example.budgettracker.model.Transaction
import com.example.budgettracker.utils.egyPound
        ...
        holder.binding.apply {
            ...
            when (item.transactionType) {
                "Income" -> {
                    ...
                    transactionAmount.text = "+ ".plus(egyPound(item.amount))
                }
                "Expense" -> {
                    transactionAmount.setTextColor(
                        ContextCompat.getColor(
